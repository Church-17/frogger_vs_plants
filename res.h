...
#define PURPLE_DARKGREEN_ID 28
#define PURPLE_RED_ID 29
#define WHITE_RED_ID 30
#define WHITE_PURPLE_ID 31
// Color pair
...
#define PURPLE_DARKGREEN COLOR_PAIR(PURPLE_DARKGREEN_ID)
#define PURPLE_RED COLOR_PAIR(PURPLE_RED_ID)
