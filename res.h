...
#define GREEN_RED_ID 12
#define GREEN_DARKGREEN_ID 13
#define GREEN_BOURDEAUX_ID 14
#define DARKGREEN_BLUE_ID 15
#define BOURDEAUX_BLUE_ID 16
// Color pair
...
#define GREEN_BOURDEAUX COLOR_PAIR(GREEN_BOURDEAUX_ID)
#define DARKGREEN_BLUE COLOR_PAIR(DARKGREEN_BLUE_ID)
#define BOURDEAUX_BLUE COLOR_PAIR(BOURDEAUX_BLUE_ID)
